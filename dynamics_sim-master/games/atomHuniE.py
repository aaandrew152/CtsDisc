...
from games.payoff_matrices.atomHUniE import generatePayoffs
...
class AtomHUniE(SymmetricNPlayerGame):
    DEFAULT_PARAMS = dict(a=4, b=0, c=2, d=4, A=1/5, errorRange=0.1)
    PLAYER_LABELS = ['']
    ...
    def __init__(self, a, b, c, d, A, errorRange, equilibrium_tolerance=0.30):
        ...
        super(AtomHUniE, self).__init__(payoff_matrix=payoff_matrix, n=2, equilibrium_tolerance=equilibrium_tolerance)
    ...
    def classify(cls, params, state, tolerance):
        ...
        return super(AtomHUniE, cls).classify(params, state, tolerance)
